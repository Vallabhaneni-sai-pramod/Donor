...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-03-16 22:06:25',NULL),('diagnostics.include_raw','OFF','2025-03-16 22:06:25',NULL),('ps_thread_trx_info.max_length','65535','2025-03-16 22:06:25',NULL),('statement_performance_analyzer.limit','100','2025-03-16 22:06:25',NULL),('statement_performance_analyzer.view',NULL,'2025-03-16 22:06:25',NULL),('statement_truncate_len','64','2025-03-16 22:06:25',NULL);
...
-- Dump completed on 2025-04-20  9:12:00
-- MySQL dump 10.13  Distrib 8.0.40, for Win64 (x86_64)
--
-- Host: localhost    Database: donorsystem
-- ------------------------------------------------------
-- Server version	8.0.40
...
INSERT INTO `donors` VALUES (1,'Imran Khan','imran@example.com'),(2,'John Doe','john@example.com');
...
CREATE TABLE `funds` (
  ...
  CONSTRAINT `funds_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`)
...
INSERT INTO `funds` VALUES (1,1,5000.00,'Books'),(2,1,12000.00,'College Fee'),(3,2,4000.00,'Laptop'),(4,2,3000.00,'Dorm'),(5,3,2500.00,'Books'),(6,1,5000.00,'Books'),(7,1,12000.00,'College Fee'),(8,2,7000.00,'Laptop');
...
CREATE TABLE `students` (
  ...
  CONSTRAINT `students_ibfk_1` FOREIGN KEY (`donor_id`) REFERENCES `donors` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `students` VALUES (1,'Rajesh','rajesh@gmail.com',3.80,'Undergraduate',15000.00,1,1),(2,'Noah','noah@example.com',3.50,'Postgraduate',18000.00,1,1),(3,'Carlos','carlos@example.com',3.90,'High School',12000.00,0,NULL),(4,'Jacob','jacob@example.com',3.70,'Undergraduate',16000.00,0,NULL);
